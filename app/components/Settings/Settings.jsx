...
const Settings = ({ setTooltipVisible, zoomIn, zoomOut, resetCamera }) => {
  ...
  const [tooltipText, setTooltipText] = useState("");  // Estado para el texto del tooltip
    ...
    <div className={styles.settings}>
      <section
        onClick={() => {
          ...
          setTooltipText("Aplicar filtros");
        }}
        onMouseEnter={() => setTooltipText("Aplicar filtros")}
      ...
      <div className={styles.settingsZoom}>
        <section
          onClick={zoomIn}
          onMouseEnter={() => setTooltipText("Acercar")}
          onMouseLeave={() => setTooltipText("")}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
            <g
        ...
        <section
          onClick={zoomOut}
          onMouseEnter={() => setTooltipText("Alejar")}
          onMouseLeave={() => setTooltipText("")}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
            <path
      ...
      <section
        onClick={() => {
          handleFullscreen();
          setTooltipText("Pantalla completa");
        }}
        onMouseEnter={() => setTooltipText("Pantalla completa")}
        onMouseLeave={() => setTooltipText("")}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
          <g
      ...
      <section
        onClick={() => {
          ...
          setTooltipText("Ver NEO aleatorio");
        }}
        onMouseEnter={() => setTooltipText("Ver NEO aleatorio")}
        onMouseLeave={() => setTooltipText("")}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 14 14">
          <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
            <path d="M7.929 3.286V1.5a1 1 0 0 0-1-1H1.5a1 1 0 0 0-1 1v5.429a1 1 0 0 0 1 1h1.786m3.785-1.858H12.5s1 0 1 1V12.5s0 1-1 1H7.071s-1 0-1-1V7.071s0-1 1-1"></path>
            <path d="M8.654 11.166a.25.25 0 1 1 0-.5m0 .5a.25.25 0 1 0 0-.5M3.221 3.505a.25.25 0 0 1 0-.5"></path>
          </g>
        </svg>
      </section>
