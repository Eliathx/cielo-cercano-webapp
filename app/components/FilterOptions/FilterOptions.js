...
const CloseButton = () => {
  ...
  return <svg width="24px" style={{cursor:"pointer"}} onClick={()=>setFilterVisible(false)} height="24px" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor"><path d="M18 6L6 18M6 6L18 18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
};
